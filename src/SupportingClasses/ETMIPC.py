...
class ETMIPC(object):
    ...
    Attributes:
            ...
            (branch, cluster) maps to a second dictionary which contains the following information:
                ...
                'sub_alignment' - The sub alignment generated by selecting only the assigned sequences from the overall
                sequence alignment analyzed by this class.
            ...
            of sequences which are not gaps in either position used for scoring of that pair.
            ...
            time (dict): Dictionary mapping a specific branch to the amount of time it took to perform analysis for
            that branch.
