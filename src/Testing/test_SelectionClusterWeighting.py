...
from Testing.test_contactScorer import (et_calcDist, et_computeAdjacency, et_calcZScore, CONTACT_DISTANCE2, pro_str,
                                        pro_pdb1, pro_pdb_1_alt_locs, pro_pdb1_scramble, pro_pdb2, pro_pdb2_scramble,
                                        pro_pdb_full, pro_pdb_full_scramble, aln_fn, protein_aln1, protein_aln2,
                                        protein_aln3)
